...
![New Mask Generation](new_mask_generation.png)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/your-username/FloodArea-UNet-Segmentation.git
...
3. **Run the Notebook:**
   Open the .ipynb file in Google Colab or Jupyter Notebook to train the model or run inference using the pre-trained weights.
